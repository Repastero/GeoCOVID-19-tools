...
for (( i=1; i<=$SLURM_NTASKS_PER_NODE; i++ )) do
	...
	srun --ntasks=$SLURM_NNODES java -Xmn512m -cp './lib/*' repast.simphony.batch.InstanceRunner \
		...
		-id $i \
'1	cantidadMuertosLimite	2000,corridas	1,diasSimulacion	318,diaInicioSimulacion	182,diasRetrasoEntradaCaso	0
2	cantidadMuertosLimite	2000,corridas	1,diasSimulacion	318,diaInicioSimulacion	182,diasRetrasoEntradaCaso	0
3	cantidadMuertosLimite	2000,corridas	1,diasSimulacion	318,diaInicioSimulacion	182,diasRetrasoEntradaCaso	0
4	cantidadMuertosLimite	2000,corridas	1,diasSimulacion	318,diaInicioSimulacion	182,diasRetrasoEntradaCaso	0' &
	sleep 2
	: '
